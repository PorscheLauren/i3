static void GENERATED_call(const int call_identifier, struct ConfigResultIR *result) {
    switch (call_identifier) {
         ...
         case 13:
             result->next_state = INITIAL;
#ifndef TEST_PARSER
             cfg_new_window(&current_match, result, get_string("windowtype"), get_string("border"), get_long("width"));
#else
           fprintf(stderr, "cfg_new_window(%s, %s, %ld)\n", get_string("windowtype"), get_string("border"), get_long("width"));
#endif
             break;
         case 14:
             result->next_state = INITIAL;
         ...
         case 15:
             result->next_state = BAR;
#ifndef TEST_PARSER
             cfg_bar_bindsym(&current_match, result, get_string("button"), get_string("command"));
#else
           fprintf(stderr, "cfg_bar_bindsym(%s, %s)\n", get_string("button"), get_string("command"));
#endif
             break;
         case 16:
             result->next_state = BAR;
         ...
         case 39:
             result->next_state = INITIAL;
#ifndef TEST_PARSER
             cfg_new_window(&current_match, result, get_string("windowtype"), get_string("border"), 2);
#else
           fprintf(stderr, "cfg_new_window(%s, %s, %d)\n", get_string("windowtype"), get_string("border"), 2);
#endif
             break;
         case 40:
             result->next_state = INITIAL;
#ifndef TEST_PARSER
             cfg_assign(&current_match, result, get_string("workspace"));
#else
           fprintf(stderr, "cfg_assign(%s)\n", get_string("workspace"));
#endif
             break;
         case 41:
             result->next_state = BAR;
...
#ifndef TEST_PARSER
             cfg_mode_binding(&current_match, result, get_string("bindtype"), get_string("modifiers"), get_string("key"), get_string("release"), get_string("border"), get_string("whole_window"), get_string("command"));
#else
           fprintf(stderr, "cfg_mode_binding(%s, %s, %s, %s, %s, %s, %s)\n", get_string("bindtype"), get_string("modifiers"), get_string("key"), get_string("release"), get_string("border"), get_string("whole_window"), get_string("command"));
#endif
             break;
         case 45:
             result->next_state = INITIAL;
       ...
       cfg_criteria_add(&current_match, result, get_string("ctype"), get_string("cvalue"));
         ...
         case 68:
             result->next_state = BAR;
#ifndef TEST_PARSER
             cfg_bar_modifier(&current_match, result, get_string("modifier"));
#else
         ...
         case 84:
             result->next_state = INITIAL;
#ifndef TEST_PARSER
             cfg_binding(&current_match, result, get_string("bindtype"), get_string("modifiers"), get_string("key"), get_string("release"), get_string("border"), get_string("whole_window"), get_string("command"));
#else
           fprintf(stderr, "cfg_binding(%s, %s, %s, %s, %s, %s, %s)\n", get_string("bindtype"), get_string("modifiers"), get_string("key"), get_string("release"), get_string("border"), get_string("whole_window"), get_string("command"));
#endif
             break;
         case 85:
             result->next_state = BAR;
         ...
         case 87:
             result->next_state = CRITERIA;
#ifndef TEST_PARSER
             cfg_criteria_init(&current_match, result, 27);
#else
       ...
       cfg_criteria_init(&current_match, result, 27);
         ...
         case 89:
             result->next_state = INITIAL;
#ifndef TEST_PARSER
             cfg_new_window(&current_match, result, get_string("windowtype"), get_string("border"), -1);
#else
       ...
       cfg_criteria_pop_state(&current_match, result);
         ...
         case 107:
             result->next_state = CRITERIA;
#ifndef TEST_PARSER
             cfg_criteria_init(&current_match, result, 61);
#else
           fprintf(stderr, "cfg_criteria_init(%d)\n", 61);
       cfg_criteria_init(&current_match, result, 61);
#endif
         ...
         case 108:
             result->next_state = CRITERIA;
#ifndef TEST_PARSER
             cfg_criteria_init(&current_match, result, 34);
#else
           fprintf(stderr, "cfg_criteria_init(%d)\n", 34);
       cfg_criteria_init(&current_match, result, 34);
#endif
