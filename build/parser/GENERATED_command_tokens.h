...
static cmdp_token tokens_GAPS_WITH_SCOPE[3] = {
...
static cmdp_token tokens_CRITERION_STR[1] = {
    { "word", "cvalue", __CALL, { 31 } }, 
};
static cmdp_token tokens_LAYOUT_TOGGLE[3] = {
    { "end", "", __CALL, { 32 } }, 
    { "'split", "toggle_mode", __CALL, { 33 } }, 
    { "'all", "toggle_mode", __CALL, { 34 } }, 
};
...
static cmdp_token tokens_TITLE_FORMAT[1] = {
    { "string", "format", __CALL, { 42 } }, 
};
static cmdp_token tokens_FULLSCREEN[4] = {
    { "'disable", "action", __CALL, { 43 } }, 
...
static cmdp_token tokens_WORKSPACE[8] = {
    ...
    { "'next_on_output", "direction", __CALL, { 46 } }, 
    { "'prev_on_output", "direction", __CALL, { 47 } }, 
    { "'next", "direction", __CALL, { 48 } }, 
    { "'prev", "direction", __CALL, { 49 } }, 
    { "'back_and_forth", "", __CALL, { 50 } }, 
...
static cmdp_token tokens_CRITERIA[13] = {
    ...
    { "'tiling", "ctype", __CALL, { 53 } }, 
    { "'floating", "ctype", __CALL, { 54 } }, 
    { "']", "", __CALL, { 55 } }, 
};
static cmdp_token tokens_DEBUGLOG[3] = {
    { "'toggle", "argument", __CALL, { 56 } }, 
    { "'on", "argument", __CALL, { 57 } }, 
    { "'off", "argument", __CALL, { 58 } }, 
};
static cmdp_token tokens_FLOATING[3] = {
    { "'enable", "floating", __CALL, { 59 } }, 
    { "'disable", "floating", __CALL, { 60 } }, 
    { "'toggle", "floating", __CALL, { 61 } }, 
};
static cmdp_token tokens_INITIAL[30] = {
    { "end", "", INITIAL, { 0 } }, 
    { "'[", "", __CALL, { 62 } }, 
    { "'move", "", MOVE, { 0 } }, 
    { "'exec", "", EXEC, { 0 } }, 
...
static cmdp_token tokens_BORDER[5] = {
    ...
    { "'none", "border_style", __CALL, { 67 } }, 
    { "'toggle", "border_style", __CALL, { 68 } }, 
    { "'1pixel", "border_style", __CALL, { 69 } }, 
};
